...
class MainWindow(QMainWindow, IUserPrompts):
    ...
    def show_help(self) -> None:
        ...
        QMessageBox.information(
            ...
            <h3>Файл</h3>
            <ul>
                <li><b>Создать (Ctrl+N)</b> - Создает новую вкладку с пустым текстовым файлом. Имя файла по умолчанию — 'NewFileN.txt', где N — номер следующего файла.</li>
                <li><b>Открыть (Ctrl+O)</b> - Открывает диалог для выбора текстового файла, который затем отображается в новой вкладке с именем файла.</li>
                <li><b>Сохранить (Ctrl+S)</b> - Сохраняет содержимое текущей вкладки. Если файл уже имеет путь, сохраняет по нему; иначе открывает диалог "Сохранить как".</li>
                <li><b>Сохранить как</b> - Открывает диалог для сохранения текущей вкладки под новым именем и в новом месте.</li>
                <li><b>Выход</b> - Закрывает приложение с запросом сохранения всех измененных вкладок.</li>
            </ul>

            <h3>Правка</h3>
            <ul>
                <li><b>Отменить</b> - Отменяет последнее действие в текущей вкладке (например, удаление текста).</li>
                <li><b>Повторить</b> - Повторяет отмененное действие в текущей вкладке.</li>
                <li><b>Вырезать</b> - Вырезает выделенный текст из текущей вкладки в буфер обмена.</li>
                <li><b>Копировать</b> - Копирует выделенный текст в буфер обмена.</li>
                <li><b>Вставить</b> - Вставляет текст из буфера обмена в текущую вкладку.</li>
                <li><b>Удалить</b> - Удаляет выделенный текст в текущей вкладке.</li>
                <li><b>Выделить все</b> - Выделяет весь текст в текущей вкладке.</li>
            </ul>

            <h3>Пуск</h3>
            <ul>
                <li><b>Запуск парсера</b> - Пока не реализован.</li>
            </ul>

            <h3>Справка</h3>
            <ul>
                <li><b>Справка</b> - Открывает этот документ с описанием функций приложения.</li>
                <li><b>О программе</b> - Показывает окно с информацией о программе (версия, автор).</li>
            </ul>

            <h2>Область ввода текста</h2>
            ...
            <ul>
                ...
                <li><b>Закрытие вкладки</b> - Крестик "×" на заголовке вкладки позволяет закрыть её с запросом сохранения изменений, если они есть.</li>
            </ul>

            <p>Перетаскивание файла из проводника в область ввода открывает его как новую вкладку. Размер шрифта текста можно изменять через меню "Текст".</p>
            """,
